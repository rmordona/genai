...
#node1.setOperations([ai.LSTM(hidden_size=6, output_size=5, output_sequence_length=2, num_layers=1, bidirectional=False, rnntype=ai.RNNtype.ONE_TO_MANY), ai.Activation(type="leakyrelu", alpha=0.01)]);
#node1.setOperations([ai.GRU(hidden_size=6, output_size=5, output_sequence_length=2, num_layers=1, bidirectional=False, rnntype=ai.RNNtype.ONE_TO_MANY), ai.Activation(type="leakyrelu", alpha=0.01)]);
...
embedding1 = [
               ...
               [  [3.11,3.12,3.13,3.14],  [3.21,2.22,3.23,3.24], [3.31,3.32,3.33,3.34]  ]  # sequence 3 of batch 1,2,3
             ];
...
target = [
           ...
           [  [3.11,3.12,3.13,3.14],  [3.21,2.22,3.23,3.24], [3.31,3.32,3.33,3.34]  ], # sequence 2 of batch 1,2,3
           [  [4.11,4.12,4.13,4.14],  [4.21,4.22,4.23,4.24], [4.31,4.32,4.33,4.34]  ] # sequence 1 of batch 1,2,3
         ];
#target = [
#           [  [2.11,2.12,2.13,2.14],  [2.21,2.22,2.23,2.24], [2.31,2.32,2.33,2.34]  ], # sequence 1 of batch 1,2,3
#           [  [3.11,3.12,3.13,3.14],  [3.21,2.22,3.23,3.24], [3.31,3.32,3.33,3.34]  ], # sequence 2 of batch 1,2,3
...
modelgraph.train(loss="mse", optimizer="adam", learnrate=0.1, iter=400);
