...
node1.setOperations([ai.RNN(hidden_size=6, output_size=5, num_layers=1, bidirectional=True, rnntype=ai.RNNtype.ONE_TO_MANY), ai.Activation(type="leakyrelu", alpha=0.01)]);
