...
node1.setOperations([ai.RNN(hidden_size=1, output_size=1, num_layers=1, bidirectional=True, rnntype=ai.RNNtype.MANY_TO_MANY), ai.Activation(type="leakyrelu", alpha=0.01)]);

embedding1 = [[[1.0, 2.0, 3.0, 4.0], [3.0, 4.0, 5.0, 6.0],[7.0,8.0,9.0,10.0]],
              [[1.0, 2.0, 3.0, 4.0], [3.0, 4.0, 5.0, 6.0],[7.0,8.0,9.0,10.0]]];
